...
describe('getGitHubUser', () => {
    it('should return user data when successful', async () => {
        ...
        (fetch as jest.Mock).mockResolvedValue({
            ok:true,
            json:jest.fn().mockResolvedValueOnce(mock_user)
        });
...
describe('GetGitHubRepos', () => {
    it('should return an array of github repos when successful', async () => {
        ...
        expect(fetch).toHaveBeenCalledWith('https://api.github.com/user/repos', expect.any(Object))
    })
